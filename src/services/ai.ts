...
export function buildWeavePrompt(a: WeaveArgs): string {
  ...
  return (
    ...
    `ПРАВИЛО ВІРНОСТІ: чим конкретніший приклад тім-ліда, тим менше додавай від себе. Якщо в прикладі вже є жива сцена - тримайся саме її; реалії WestCamp і скілтайми бери лише щоб правильно НАЗВАТИ й розтлумачити те, що описав тім-лід, а не щоб додати нові події, локації чи активності. Загальний світ табору вплітай тільки тоді, коли приклад надто скупий. ` +
    ...
    `СУВОРО: не вигадуй сцен, назв активностей, локацій чи подій, яких немає в прикладі тім-ліда або в блоці «Реалії WestCamp». Краще згадати реальний скілтайм, ніж придумати красиву сцену. Без повторення coverQuote дослівно.`
  );
}
